...
export function CheckoutHeader({ currentStep }: CheckoutHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-[100] px-4 lg:px-[60px] py-5 flex justify-between items-center bg-[rgba(10,10,10,0.95)] border-b border-[#2A2A2A] backdrop-blur-[10px]">
